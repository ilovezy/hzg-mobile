<template>
  <div class="rollnotice" :style="{height: height + 'px'}">
...
<script type="text/babel">
  export default {
    ...
    methods: {
      init() {
        this.destroy();
        this.items = this.$children.filter(item => item.$options.name === 'rollnotice-item');
...
<style lang="less">
  @import "../../../assets/styles/components/rollnotice.less";
</style>
