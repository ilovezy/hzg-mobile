<template>
  <div>
    ...
    <div class="cityselect" :class="show ? 'cityselect-active' : ''">
      <div class="cityselect-header">
        ...
        <div v-show="ready" class="cityselect-nav">
          <a href="javascript:;"
            ...
            :class="nav.index == 0 ? 'cityselect-nav-active' : ''">{{nav.txt1}}</a> <a href="javascript:;"
          v-show="!!nav.txt2"
          @click.stop="backoffView(1)"
          :class="nav.index == 1 ? 'cityselect-nav-active' : ''">{{nav.txt2}}</a> <a href="javascript:;"
          v-show="!!nav.txt3"
...
<style lang="less">
  @import "../../../assets/styles/components/cityselect.less";
</style>
