<template>
  <layout class="bg-white">
    ...
    <!--</navbar>-->
    <div class="landing">
      <div class="banner"><img src="../../landing/landing3/images/banner.jpg"></div>
        ...
        <div class="info">
          <table class="reg-table">
            <tr>
              ...
              <th width="33%" style="border-top-right-radius: 8px">获得奖励</th>
            </tr>
            <tr>
              <td class="-br">首次投资30天及以上定期理财产品<br>满5000元及以上</td>
              <td>100元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资30天及以上定期理财产品<br>满10000元及以上</td>
              <td>220元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资30天及以上定期理财产品<br>满20000元及以上</td>
              <td>480元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资60天及以上定期理财产品<br>满10000元及以上</td>
              <td>400元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资60天及以上定期理财产品<br>满30000元及以上</td>
              <td>1260元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资60天及以上定期理财产品<br>满50000元及以上</td>
              <td>2150元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资90天及以上定期理财产品<br>满20000元及以上</td>
              <td>1000元红包</td>
            </tr>
            <tr>
              <td class="-br">首次投资90天及以上定期理财产品<br>满50000元及以上</td>
              <td>2900元红包</td>
            </tr>
            <tr>
              <td class="-br" style="border-bottom-left-radius: 8px">首次投资90天及以上定期理财产品<br>满100000元及以上</td>
              <td style="border-bottom-right-radius: 8px">6000元红包</td>
            </tr>
          </table>

        </div>
      </div>
      <div class="repeat-invest">
        <h3 class="title"></h3>
        <div class="info">
          <table class="reg-table">
            <tr>
              <th style="border-top-left-radius: 8px">复投满足投资条件</th>
              <th width="33%" style="border-top-right-radius: 8px;">获得奖励</th>
            </tr>
            <tr>
              <td class="-br">首次后再次投资30天及以上理财产品<br>单笔10000元以上</td>
              <td>投资金额*1.5%</td>
            </tr>
            <tr>
              <td class="-br">首次后再次投资60天及以上理财产品<br>单笔10000元以上</td>
              <td>投资金额*2.2%</td>
            </tr>
            <tr>
              <td class="-br" style="border-bottom-left-radius: 8px">首次后再次投资90天及以上理财产品<br>单笔10000元以上</td>
              <td style="border-bottom-right-radius: 8px">投资金额*3.0%</td>
            </tr>
          </table>
        </div>
      </div>
        ...
        <div class="info">
          <table class="reg-table">
            <tr>
              ...
              <th>项目天数</th>
              <th width="33%" style="border-top-right-radius: 8px">投资门槛</th>
            </tr>
            <tr>
              <td>28元</td>
              <td>投资30天及以上</td>
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  .landing
    ...
    margin-bottom -.2rem
    min-height 100%
    background-color #1a63fe
    .banner
      img
        width 100%
    .register-form
      background url("images/reg_bg.jpg") no-repeat center .2rem / contain
      padding-top 1.4rem
    .land-reg
      margin 0 auto
      width 7.5rem
    ...
    .first-invest
      .title
        background-image url("images/first_invest_title.jpg")
    .repeat-invest
      .title
        background-image url("images/repeat_invest_title.jpg")
    .newbie
      .title
        background-image url("images/newbie_title.jpg")
    .reg-table
      width 100%
      background-color #fff
      border-radius 8px
